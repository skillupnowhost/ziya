...
export default function HeroSection() {
  ...
  return (
    <section className="hero-section relative w-full bg-gradient-to-br from-rose-50 via-pink-50/40 to-white">
      {/* Soft background blobs — overflow-hidden scoped so blobs don't escape */}
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-10 lg:px-16 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center w-full pt-10 pb-12 lg:pt-14 lg:pb-14">
          ...
          <div className="order-2 lg:order-1 text-center lg:text-left">
            <span className="inline-block bg-rose-400 text-white text-xs font-semibold px-4 py-1.5 rounded-full mb-5 tracking-widest uppercase shadow-md shadow-rose-300/30">
              New Collection
            </span>
            <p className="text-rose-400 text-xs sm:text-sm tracking-[0.4em] uppercase mb-3 font-medium">
              Curated Elegance
            </p>
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 leading-tight mb-5 font-serif">
              Indo Korean<br />
              <span className="text-rose-400">Fashion</span>
            </h1>
            <p className="text-gray-500 text-sm sm:text-base mb-8 leading-relaxed max-w-md mx-auto lg:mx-0">
              Discover timeless pieces inspired by the streets of Seoul — curated with love for the modern woman.
            </p>
            <div className="flex flex-wrap gap-3 justify-center lg:justify-start mb-6 lg:mb-10">
              <Link
                href="/products"
          ...
          <div className="order-1 lg:order-2 relative flex justify-center lg:justify-end">
            <div className="relative w-full mx-6 sm:mx-0 sm:w-80 lg:w-[380px] xl:w-[420px]">
              ...
              <img
                ...
                alt="Korean Fashion"
                className="hero-image relative w-full rounded-3xl shadow-2xl shadow-rose-300/40"
              />

              {/* Soft cloud-like radial fade overlay */}
              <div className="hero-cloud-overlay absolute inset-0 rounded-3xl pointer-events-none" />

              {/* Floating info badge — Free Shipping */}
              <div className="absolute -bottom-4 -left-2 sm:-left-8 bg-white/90 backdrop-blur-md rounded-lg sm:rounded-2xl px-2 py-1.5 sm:px-4 sm:py-3 shadow-lg shadow-rose-100/50 border border-white/70 flex items-center gap-1.5 sm:gap-3">
              ...
              {/* Floating top badge — Trending */}
              <div className="absolute -top-2 -right-2 sm:-right-5 bg-gradient-to-br from-rose-400 to-orange-400 text-white rounded-lg sm:rounded-2xl px-1.5 py-1 sm:px-3 sm:py-2.5 shadow-md shadow-rose-400/40 border border-white/20 text-center flex flex-col items-center gap-0.5">
