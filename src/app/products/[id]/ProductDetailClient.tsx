...
export default function ProductDetailClient() {
  ...
  const handleAddToCart = () => {
    if (!product) return;
    if (liveStock <= 0) { toast.error('This product is currently out of stock'); return; }
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 mb-16">
        ...
        <div>
          ...
          {/* Out of Stock Banner */}
          {liveStock === 0 && (
            <div className="mb-6 p-4 bg-red-50 border-2 border-red-200 rounded-2xl flex items-center gap-3 animate-pulse">
              ...
              <div>
                ...
                <p className="text-xs text-red-500 mt-0.5">This product is currently unavailable. Please check back later.</p>
              </div>
            </div>
          )}
